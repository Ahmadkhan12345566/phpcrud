...
if (isset($_POST["submit"])){
    ...
    $sql = "Update `users` set email='$email',username='$username',firstname='$firstname',lastname='$lastname' where id=$id";
...
<div class="container">
    ...
    <form  method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  placeholder="Enter firstname" name="firstname" value="<?php echo $firstname?>">
        </div>
        <div class="form-group">
